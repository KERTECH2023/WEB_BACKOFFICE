...
const SingleC = () => {
  ...
  const handleSubmiteC = () => {
    ...
    // Handle validations
    axios
      .put(process.env.REACT_APP_BASE_URL + `/Chauff/updatestatusss/${id}`
      ,{ headers: {
  ...
  .catch(err =>{
    ...
    const handleSubmite = () => {
        ...
        // Handle validations
        axios
          .put(process.env.REACT_APP_BASE_URL + `/agent/updatestatuss/${id}`
          ,{ headers: {
            'Content-Type': 'multipart/form-data',
          },})
    ...
    const handleSubmiteCl = () => {
      ...
      // Handle validations
      axios
        .put(process.env.REACT_APP_BASE_URL + `/Client/updatestatuss/${id}`
        ,{ headers: {
          'Content-Type': 'multipart/form-data',
        },})
