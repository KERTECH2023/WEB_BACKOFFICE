...
const NewCh = () => {
  ...
  if (!prenomRegex.test(Prenom)) {
    ...
    return ;
        ...
        // Handle validations
        axios
          .post(process.env.NEXT_PUBLIC_BASE_URL + "/Chauff/AjoutChauf", { Nom, Prenom, email, phone,photoAvatar,photoCin, photoPermisRec,photoPermisVer,photoVtc,gender , role ,DateNaissance ,Nationalite ,licenseNo , cnicNo ,address,postalCode}
          ,{ headers: {
      ...
      .catch(err =>{
        ...
        <label>Nationalite :</label><br />
                ...
                <p className="item">
                    ...
                    <input type="file"  onChange={e => setphotoVtc(e.target.files[0])} name="vtc" className='InputBox' id="vtc" />
